...
AbstractOpenGLPlan* OpenGLPlanFactory::operator() (const FITS::HeaderDataUnit<FITS::DataUnit<quint8>>& hdu) const {
	if (hdu.data().depth() > 1)
		return resolveOpenGLPlan<Uint8OpenGL33ArrayPlan, Uint8OpenGL30ArrayPlan, Uint8OpenGLArrayPlan, Uint8OpenGLES30ArrayPlan>(features_, hdu);
...
AbstractOpenGLPlan* OpenGLPlanFactory::operator() (const FITS::HeaderDataUnit<FITS::DataUnit<qint16>>& hdu) const {
	if (hdu.data().depth() > 1)
		return resolveOpenGLPlan<Int16OpenGL33ArrayPlan, Int16OpenGL30ArrayPlan, Int16OpenGLArrayPlan, Int16OpenGLES30ArrayPlan>(features_, hdu);
...
AbstractOpenGLPlan* OpenGLPlanFactory::operator() (const FITS::HeaderDataUnit<FITS::DataUnit<qint32>>& hdu) const {
	if (hdu.data().depth() > 1)
		return resolveOpenGLPlan<Int32OpenGL33ArrayPlan, Int32OpenGL30ArrayPlan, Int32OpenGLArrayPlan, Int32OpenGLES30ArrayPlan>(features_, hdu);
