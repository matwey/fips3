...
Uint8OpenGLES30ArrayPlan::Uint8OpenGLES30ArrayPlan(const FITS::HeaderDataUnit<FITS::DataUnit<quint8>>& hdu):
	AbstractOpenGLES30Plan<Uint8OpenGLES3TextureArray>("uint8-opengles3.0-array", hdu, makeMinMax(hdu), makeInstrumentalMinMax(hdu), 1, 1) {
}

QString Uint8OpenGLES30ArrayPlan::fragmentShaderSourceCode() const {
	static const QString source = R"(
	#version 300 es
	#ifdef GL_ES
		#ifdef GL_FRAGMENT_PRECISION_HIGH
...
Int16OpenGLES30ArrayPlan::Int16OpenGLES30ArrayPlan(const FITS::HeaderDataUnit<FITS::DataUnit<qint16>>& hdu):
	AbstractOpenGLES30Plan<Int16OpenGLES3TextureArray>("int16-opengles3.0-array", hdu, makeMinMax(hdu), makeInstrumentalMinMax(hdu), 2, 1) {
}

QString Int16OpenGLES30ArrayPlan::fragmentShaderSourceCode() const {
	static const QString source = R"(
	#version 300 es
	#ifdef GL_ES
		#ifdef GL_FRAGMENT_PRECISION_HIGH
